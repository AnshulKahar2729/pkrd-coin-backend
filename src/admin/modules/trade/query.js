...
module.exports = {
  ...
  find_one_with_populate: async (
    model,
    whereCondition = {},
    includeModule = {}
  ) => {
    try {
      let getData = await models[model]
        .findOne(whereCondition)
        .populate(includeModule.main_id, includeModule.values);
      return getData;
    } catch (err) {
      throw err;
    }
  ...
  find_one_with_populates: async (
    ...
    try {
      let getData = await models[model]
        .findOne(whereCondition)
        .populate(includeModule.main_id)
        .populate(includeModules.main_id, includeModules.values);
      return getData;
    } catch (err) {
      throw err;
    }
  ...
  update_one: async (model, whereCondition = {}, addField = {}) => {
    try {
      let createData = await models[model].updateOne(whereCondition, addField);
      return createData;
    } catch (err) {
      return err;
    }
  ...
  create: async (model, addField = {}) => {
    try {
      let createData = await models[model].create(addField);
      return createData;
    } catch (err) {
      return err;
    }
  ...
  create_with_populate: async (model, addField = {}) => {
    try {
      let createData = await models[model].create(addField);
      let getData = await models[model]
        .findOne({ _id: createData._id })
        // nesting populate
        .populate("bid_id", "user_id");
      return getData;
    } catch (err) {
      return;
    }
  ...
  find_all_and_count_with_populate_include_with_pagination: async (
    model,
    whereCondition = {},
    includeModule = {},
    PAGE_SIZE,
  ...
  find_all_and_count_with_populates_include_with_pagination: async (
    model,
    whereCondition = {},
    includeModule = {},
    PAGE_SIZE,
  ...
  find_all_and_count_with_populate_include_with_pagination_search: async (
    model,
    whereCondition = {},
    includeModule = {},
    PAGE_SIZE,
