const { get_list_pagination, add_data, edit_data, get_data_by_id, update_data_status, delete_data, get_data_by_user_id } = require('./services');
...
module.exports = {
    ...
    view: async (req, res) => {
        try {
            let data = await get_data_by_user_id(req, res)
            if (data) {
